...
class AgentLoop:
    ...
    def __init__(
        ...
        self.execution_mode = str(execution_mode or "fast").lower().strip()
        ...
        if self.execution_mode == "autonomous":
            ...
            self.max_completion_recovery_iterations = min(
                1,
                max(0, int(max_completion_recovery_iterations)),
            )
    ...
    def run(
        ...
        self.report_progress(
            f"Execution Mode: {self.execution_mode.upper()} "
            f"(max_iterations={self.max_iterations}, "
            f"completion_recovery={self.max_completion_recovery_iterations})"
        )
